...
radiusfeat=1.0 # float - radius of circular feature or in case of ellipses the semi-axis perpendicular to propagation
ratiofeat=1.5 # float - ratio: axis in the direction of propagation / axis perpendicular to propagation
