...
radiusfeat=1.5 # float - radius of circular feature or in case of ellipses the semi-axis perpendicular to propagation
ratiofeat=2.0/3.0 # float - ratio: axis in the direction of propagation / axis perpendicular to propagation
...
gammas=np.array([0.0]) # float - ratio: speed inside / outside of features
...
rhos=np.array([0.025,0.050,0.075,0.100,0.125,0.150,0.175,0.200]) # float - number density of features
rhos=rhos/1.5/1.5
