...
# setting the stage
widthch=150.0 # float - width of channel - along y
lengthch=500.0 # float - length of channel - along x - in propagation direction
...
gammas=np.array([2.0]) # float - ratio: speed inside / outside of features
...
rhos=np.array([0.150]) # float - number density of features
